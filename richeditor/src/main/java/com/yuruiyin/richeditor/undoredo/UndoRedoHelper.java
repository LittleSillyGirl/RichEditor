...
import com.yuruiyin.richeditor.RichHelper;
...
public class UndoRedoHelper {
    ...
    private void undoRedoChangeStyle(UndoRedoHelper.Action action) {
        richHelper.toggleStyleFromUndoRedo(action.richType, action.startCursor, action.endCursor);
    }
    ...
    public static class Action {
        ...
        public Action(int startCursor, int endCursor, @InlineSpanEnum String richType) {
            this.startCursor = startCursor;
